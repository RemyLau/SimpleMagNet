...
from utils.edge_data import (
    generate_dataset_3class,
    in_out_degree,
...
def main(args):
    ...
    datasets = generate_dataset_3class(
        edge_index,
        size,
        save_file,
        splits=10,
    ...
    for i in range(10):
        ...
        if args.task != 2:
            ...
            log_str = (
                "val_acc_latest: {val_acc_latest:.4f}, "
                + "test_acc_latest: {test_acc_latest:.4f}, "
            )
            log_str2 = log_str.format(
            ...
            [
                ...
                [
                    test_acc_full_latest,
                    test_acc_latest,
                    test_auc_latest,
                    test_f1_micro_latest,
            ...
            ####################
            log_str = (
                "val_acc_full:{val_acc_full:.3f}, val_acc: {val_acc:.3f} "
